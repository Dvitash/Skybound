...
public class MultiHeart extends Pickup {
    ...
    public MultiHeart(BufferedImage image, Point startLocation, TileType tileType, float scale, Rectangle bounds, String pickupName, double weight) {
